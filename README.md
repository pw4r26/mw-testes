# MedWork — ambiente público de testes

Este repositório contém somente a versão demonstrativa/PWA do MedWork para testes de interface, instalação e funcionamento offline.
